...
export const prompts: Prompts = [
  {
    ...
    promptOptions: [
      ...
      {
        type: 'Transcription',
        prompt: 'Transkribera den handskrivna texten i bilden. Bibehåll radbrytningar. Svara endast med själva transkriptionen.'
      }
    ],
  ...
  },
  {
    ...
    promptOptions: [
      ...
      {
        type: 'Transcription',
        prompt: 'Transkriboi kuvan käsinkirjoitettu teksti. Säilytä rivinvaihdot. Vastaa ainoastaan transkriboidulla tekstillä.'
      }
    ],
  ...
  },
  {
    ...
    promptOptions: [
      ...
      {
        type: 'Transcription',
        prompt: 'Transcribe the handwritten text in the image. Preserve line breaks. Answer with just the actual transcription.'
      }
    ],
